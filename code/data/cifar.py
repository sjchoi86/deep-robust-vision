...
from .data_util import download_url, check_integrity, noisify
    ...
    def __init__(self, root, train=True,
        ...
        if self.train:
            ...
            if noise_type !='clean':
                ...
                self.train_noisy_labels, self.actual_noise_rate = noisify(dataset=self.dataset, train_labels=self.train_labels, 
